...
export const finalConsonants = [
  ...
  { char: 'ㄷ', romanization: 't', name: '디귿', examples: ['갇 (gat)', '곧 (got)', '굳 (gut)'] },
  { char: 'ㄹ', romanization: 'l', name: '리을', examples: ['갈 (gal)', '골 (gol)', '굴 (gul)'] },
  { char: 'ㅁ', romanization: 'm', name: '미음', examples: ['감 (gam)', '곰 (gom)', '굼 (gum)'] },
  { char: 'ㅂ', romanization: 'p', name: '비읍', examples: ['갑 (gap)', '곱 (gop)', '굽 (gup)'] },
  { char: 'ㅇ', romanization: 'ng', name: '이응', examples: ['강 (gang)', '공 (gong)', '궁 (gung)'] },
  { char: 'ㅈ', romanization: 't', name: '지읒', examples: ['갖 (gat)', '곶 (got)', '궂 (gut)'] },
  { char: 'ㅊ', romanization: 't', name: '치읓', examples: ['갗 (gat)', '곷 (got)', '궃 (gut)'] },
  { char: 'ㅋ', romanization: 'k', name: '키읔', examples: ['갘 (gak)', '곸 (gok)', '궄 (guk)'] },
  { char: 'ㅌ', romanization: 't', name: '티읕', examples: ['갇 (gat)', '곧 (got)', '궅 (gut)'] },
  { char: 'ㅍ', romanization: 'p', name: '피읍', examples: ['갚 (gap)', '곺 (gop)', '궆 (gup)'] },
  { char: 'ㅎ', romanization: 't', name: '히읗', examples: ['갛 (gat)', '곻 (got)', '궇 (gut)'] },
  { char: 'ㄲ', romanization: 'k', name: '쌍기역', examples: ['갂 (gak)', '곢 (gok)', '굮 (guk)'] },
  { char: 'ㅆ', romanization: 't', name: '쌍시옷', examples: ['갔 (gat)', '곴 (got)', '궀 (gut)'] },
]
...
export const SPELL_CONSONANTS = ['ㄱ','ㄲ','ㄳ','ㄴ','ㄵ','ㄶ','ㄷ','ㄸ','ㄹ','ㄺ','ㄻ','ㄼ','ㄽ','ㄾ','ㄿ','ㅀ','ㅁ','ㅂ','ㅃ','ㅄ','ㅅ','ㅆ','ㅇ','ㅈ','ㅉ','ㅊ','ㅋ','ㅌ','ㅍ','ㅎ']
